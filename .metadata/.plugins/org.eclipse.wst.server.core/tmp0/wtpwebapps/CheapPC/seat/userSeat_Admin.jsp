    ...
    <div class="toggle-button-cover">
      <div class="button-cover">
        <div class="button r" id="button-1" >
         ...
         <div id="0-user" style="padding-left:15px; font-size:20px; color:#708090; padding-bottom:10px;"> </div>
        ...
        <div class="button r" id="button-2">
          <div class="knobs"></div>
             <div class="layer">
                ...
                <div id="1-user" style="padding-left:5px; font-size:20px; color:#708090; padding-bottom:10px;"> </div>
        ...
        <div class="button r" id="button-3">
          ...
          <div class="layer">
             <div class="2" style="text-align:center;padding-top:10px;">00:00:00</div>
                ...
                <div id="2-user" style="padding-left:5px; font-size:20px; color:#708090; padding-bottom:10px;"> </div>
      ...
      <div class="button-cover">
        <div class="button r" id="button-4">
          ...
          <div class="3" style="text-align:center;padding-top:10px;">00:00:00</div>
                ...
                <div id="3-user" style="padding-left:5px; font-size:20px; color:#708090; padding-bottom:10px;"> </div>
        ...
        <div class="button r" id="button-5">
          ...
          <div class="layer">
             <div class="4" style="text-align:center;padding-top:10px;">00:00:00</div>
                ...
                <div id="4-user" style="padding-left:5px; font-size:20px; color:#708090; padding-bottom:10px;"> </div>
                <div class="1buttons" style="top:20%; padding-left:17px; ">      
