...
<body>
	...
	%>
			<jsp:forward page="userSeat_Admin.jsp"></jsp:forward>
	<%
		} 
	%>
...
<div class="nav-header">
    ...
    <div class="header-links">
      <ul>
        ...
        <li data-menuanchor="secondPage"><a href="../food/food_main.jsp">MENU</a></li>
      </ul>
    </div>
  </div>
  </div>
        ...
        <div class="button r" id="button-2">
          <div class="knobs"></div>
             <div class="layer">
                ...
                <div class="1buttons" style="top:20%; padding-left:10px; ">      
            </div>
         </div>
        </div>
      </div>
        ...
        <div class="button r" id="button-3">
          ...
          <div class="layer">
             <div class="2" style="text-align:center;padding-top:10px;">00:00:00</div>
                ...
                <div class="2buttons" style="top:20%; padding-left:10px; "> 
            </div>
         </div>
        </div>
      </div>
      ...
      <div class="button-cover">
        <div class="button r" id="button-4">
          ...
          <div class="3" style="text-align:center;padding-top:10px;">00:00:00</div>
                ...
                <div class="3buttons" style="top:20%; padding-left:10px; ">              
            </div>
         </div>
